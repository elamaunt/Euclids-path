...
`MersennePaymentConflict.lean` переносит на Мерсенн бухгалтерию из [17. Payment ledger](17_PaymentLedger.md). Центры
...
её утверждение об отсутствии проведено через манифестационную архитектуру Римана: свидетель
...
теоремой (`mersenneRefutation_carries_engine`). Трилемма четвёртой границы пройдена, но поле
