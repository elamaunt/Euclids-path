...
that alone remains. The Lean sources are \code{Engine/YangMillsFront.lean} and
\code{Engine/HodgeFront.lean}.
...
The epistemic complement (\code{Engine/YangMillsEpistemic.lean}) closes the internal door as for
...
The epistemic complement (\code{Engine/HodgeEpistemic.lean}) closes the internal door. Self-grounding
