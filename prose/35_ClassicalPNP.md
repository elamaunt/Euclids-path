...
> Проза-предшественник: [24. BoundaryDecomp], раздел «Структурная аналогия P/NP».
...
В [24] мы заметили, что стена близнецов имеет узнаваемую вычислительную анатомию: прямой ход
...
5-адическая цепь, что в [24] сузила финальный узел близнецов до $A \ge 5$. Безусловная теорема
