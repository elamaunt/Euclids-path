...
существует — бесконечная 5-адическая цепь потоков (`fiveAdicChainFlow`) пиджонхолом (конечный
ключ не может инъективно пометить бесконечное семейство, см. [словарь](GLOSSARY.md)) создаёт
...
относительно произвольного фрейма не стоит ничего.

Петля честности замыкается в
