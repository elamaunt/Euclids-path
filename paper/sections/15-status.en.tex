...
quarantine: the axiom \axiom{} and its theorem retinue in \code{Engine/CausalClosureAxiom.lean}
...
The script \code{scripts/VerifyAll.lean} enumerates every non-internal \code{EuclidsPath}
...
development, and \code{lake env lean scripts/VerifyAll.lean} re-establishes the two invariants of
