...
> `prose/NN_*.md` (парная проза, 00→40) и модули `EuclidsPath/Engine/*.lean` (машинная проверка).
...
> `Engine/CausalClosureAxiom.lean`, ровно 37 таких деклараций, утечек нет — верификатор
...
буквально — на голом ядре Lean; главы 33–40 разворачивают первопричину (теперь с двумя
