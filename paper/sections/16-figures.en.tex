...
come from \code{tools/fractal/euclid\_fractal.py}; the two cosmological views,
Figures~\ref{fig:observer-horizon}--\ref{fig:time-sphere}, from
\code{tools/fractal/euclid\_cosmology.py}. Both draw the same mathematical
...
\code{tools/fractal/euclid\_fractal.py::old\_peel\_tree}. Fix $A=200$ and sieve
...
\code{tools/fractal/euclid\_fractal.py::rank\_field}. Parameters $A=60$,
...
\code{tools/fractal/euclid\_fractal.py::twin\_spiral}. For each centre
...
\code{tools/fractal/euclid\_fractal.py::descent\_landscape}. For every centre
...
\code{tools/fractal/euclid\_fractal.py::twin\_line\_genealogy}. Centres
...
\code{tools/fractal/euclid\_fractal.py::genealogy\_ornament} ($M=4200$,
...
\code{tools/fractal/euclid\_cosmology.py::observer\_horizon} ($M=9000$,
...
\code{tools/fractal/euclid\_cosmology.py::time\_sphere} ($M=7000$,
