...
> `Engine/AtomicSNOL.lean` (пост-аудиторская атомизация SNOL — структурный рефакторинг, латеральный
> шаг). Всё — редукции, НЕ закрытие; см. разделы ниже. Числа: `tools/RESULTS_global_absorber`.
