...
`step00FirstCause` (the intentional event "0 → 1" with four causal boundaries) is marked 🟡 —
...
At build time: **exactly one** non-standard axiom, **52** declarations depending on it, **one**
