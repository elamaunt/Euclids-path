...
на голом ядре Lean~4, без \code{mathlib} (\srcpath{EuclidsPath/Engine/EPMI.lean},
\srcpath{EuclidsPath/Engine/Irreversibility.lean}, \srcpath{EuclidsPath/Engine/UniversalEngine.lean})~\cite{lean4,euclidspath-repo}.
...
$0,1,2,\dots$ --- бесконечная строго возрастающая траектория. Прибавление $+1$ --- «топливо»: б\'{о}льших
