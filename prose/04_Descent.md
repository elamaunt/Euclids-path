...
Теперь мы покажем, куда
эта двойка девается, когда двигатель — запрещённая бесконечная цепь строгого спуска (см. [словарь](GLOSSARY.md)) — делает шаг: спуск не уничтожает зазор, а **переносит** его на
...
Первое наблюдение — строгий спуск по высоте (высота — это ранг состояния, конечное топливо двигателя; см. [словарь](GLOSSARY.md)). Поскольку `a>A` и `6m+σ = a(6n+ε)`, множитель `a`
