...
import EuclidsPath.Engine.DyadicBlowup -- T1: ригорозное ядро супер-линейного взрыва (y'≥Cy² ⟹ конечное время) + модель Кац–Павлович (телескоп энергии) → dyadic_blowup; связующий cascade-drive — именованная гипотеза (механизм KP, не выведен из сырых связей — честно раскрыто); каскад = РЕАЛИЗОВАННЫЙ двигатель, опровержение наивного закрытия НС
