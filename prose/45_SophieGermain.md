...
пилится ли она (строит кованого свидетеля — машинный контрпример, см. [словарь](GLOSSARY.md)) или нет. Мерсеннова `4m+1` не пилилась, пятиадическая `5m+1`
...
книги на этом масштабе — то есть бухгалтерию без свободной энергии (см. [словарь](GLOSSARY.md)).
...
Отсюда `no_internalisedSGGround` и `sgCause_unknowable` (🟢): **закон
...
Оговорку делаем сразу: **«опровержение = двигатель» у Софи
Жермен условно на закон** — слабее безусловного коллатцевского хвоста, и мы этого не прячем.
