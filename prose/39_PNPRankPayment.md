...
бесконечна:* тип `concreteFamily A 1`.Index бесконечен, свидетель — инъекция пятиадической цепи `fiveAdicChainFlow` (та самая, что опровергла ветвь $A \le 4$ в [главе 24](24_BoundaryDecomp.md)).
...
У близнецов декрет несёт живую границу, а Риман был честной второй границей, впоследствии
**отсоединённой** от декрета (Option A). Естественно спросить: не стоит ли добавить
P/NP-границу? Ответ — **нет, и это доказано машинно**. Мы проверили все три мыслимые формы
...
живая граница декрета (узел, 🟡), Риман — риманова граница, **отсоединённая** от декрета (Option A —
закон манифестации, отсоединённый фронт, а не живая граница), а P/NP — **зелёная
