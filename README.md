...
| 41′ | *(постскриптум)* **НС: интеграл собран на ℝ³ (бокс)** | [41](prose/41_NSSmoothness.md) | `Engine/NavierStokesR3Assembly` | 🟢 R1 производная под интегралом + R2 дивергенция (грани гаснут) + энергобаланс ВЫВЕДЕН на бокс-классе ⟹ каскадная гладкость БЕЗ декрета; 🔴 предел box→ℝ³, три E3-киллера |
