...
**План закрытия.** (H) — не счётная и не распределительная гипотеза; она в духе `regenerate` из [20 NOPSL](20_NOPSL.md) и Леммы 6.1 о регенерации из [21 Regeneration](21_Regeneration.md).
