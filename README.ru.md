...
flowchart TD
    ...
    ROOT --> CL["Коллатц 🟢<br/>декрет пал: закон каната опровергнут (n=27)"]
...
машина Тьюринга — в формализации отсутствует). Коллатц прошёл полный цикл дисциплины: его закон каната был
