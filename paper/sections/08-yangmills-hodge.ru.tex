...
--- \srcpath{Engine/YangMillsFront.lean} и \srcpath{Engine/HodgeFront.lean}.
...
Эпистемическое дополнение (\srcpath{Engine/YangMillsEpistemic.lean}) закрывает внутреннюю дверь, как в
...
Эпистемическое дополнение (\srcpath{Engine/HodgeEpistemic.lean}) закрывает внутреннюю дверь.
